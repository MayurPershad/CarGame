"""
@author: Mayur Pershad
@email: Mayur.pershads@gmail.com
@date: 17 july 2021
"""
import random
...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Mayur')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Mayur Pershad", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("mayur.pershads@gmail.com", True, self.white)
